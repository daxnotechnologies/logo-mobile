...
class _FirstPageState extends State<FirstPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      DecorationImage(
          image:
          NetworkImage('http://clubhouse.rotaryeclublahore.org/wp-content/themes/cera/assets/images/avatars/user-avatar.png'),
          fit: BoxFit.contain) :
      DecorationImage(
      image:
      ...
      color: Colors.white)),
                ...
                Obx(()=>c.placessearch.isEmpty?Container(
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => Details(
                                      ...
                                      description:
                                      c.placessearch[index].description,
                                      email: c.placessearch[index].email,
                                      image: c.placessearch[index].image,
                                      name: c.placessearch[index].name,
                                      phone: c.placessearch[index].phone,
                                      ratings:
                                      c.placessearch[index].ratings,
                                      type: c.placessearch[index].type,
                                      location:
                                      c.placessearch[index].location,
                                    )));
                          },
                          child: Container(
                              decoration: BoxDecoration(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        CustomWidget(
                                            text: c.placessearch[index].name,
                                            size: 13,
                                            color: Colors.white,
                                            weight: FontWeight.w500),
                                        SizedBox(
